class MoviesController < ApplicationController
  ...
  private
    ...
    def movie_params
      p = params.require(:movie).permit(:imdbID, :imdbVotes, :imdbRating, :Title, :Language, :TagLine, :ReleaseDate, :Poster, :Popularity, :Actors, :BoxOffice, :Country, :Genres, :Director, :Metascore, :Plot, :Runtime, :Website, :Writer, :Year, :ProductionCompany, :criteria)
