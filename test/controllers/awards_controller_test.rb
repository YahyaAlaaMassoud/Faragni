...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { description: @award.description, name: @award.name, year: @award.year } }, as: :json
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { description: @award.description, name: @award.name, year: @award.year } }, as: :json
    assert_response 200
  end
